...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 257888c0-bcc8-47ea-a695-c09f77b1b5ef
```

> `257888c0-bcc8-47ea-a695-c09f77b1b5ef` is the password of the certificate, you can change it to any password you want.
